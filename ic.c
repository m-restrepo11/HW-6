 ...
 *      de la primera galaxia de disco orbiten de manera estable en círculos alrededor de la masa central.
 *      Durante el código se trabaja con unidades de Kiloparsecs, Giga-años, Tera-masas solares.
 *
 *     Se reciben 4 datos ingresados por el usuario al momento de la ejecución del programa: posición inicial en X y en Y;
...
int main(int argc, char **argv) {
	...
	if (argc!=6){
		printf("Se necesitan 5 parámetros para iniciar el simulador");
		exit(1);
	}
